...
class ContractPricing:
    ...
    def calculatePricing(self, passValidation=False):
        print('Calculating Contract Pricing...')
        self.details['WorkOrder'] = self.wo._wo['WorkOrder']

        printError('ERROR: Unable to proceed pricing calculation for WO# ' + self.wo._workOrderNumber + ' - Contract Pricing not available\n')   
